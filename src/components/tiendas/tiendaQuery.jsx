...
import TiendaSave from "./tiendaSave";
  ...
  return (
    <>
      ...
      <Modal flag={saveDlg} setFlag={setSaveDlg} header="Nuevo Registro">
        <TiendaSave isUpdate={false} find={find} />
      </Modal>

      <Modal flag={editDlg} setFlag={setEditDlg} header="Editar Registro">
        {model && <TiendaSave isUpdate={true} find={find} model={model} />}
      </Modal>
      ...
      <div className="row">
        <div className="col s12">
          <Card>
            <div className="row">
              <div className="col s12">
                <TiendaTable data={data} actionBody={actionBody} />
              </div>
            </div>
          </Card>
        </div>
